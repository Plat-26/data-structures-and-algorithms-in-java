...
/**
 * A LinkedList stores data in nodes consisting of the data value and the reference/pointer to its
 * next node.
 * <p>
 ...
 * has nodes with pointers to the previous and next nodes.
 * <p>
 * Linked lists are represented as a single node which is first node/head of the list
 */
